...
public class ModSounds {
    ...
    public static final ForgeSoundType HOLLOW_METAL_BLOCK_SOUNDS = new ForgeSoundType(2f,1.5f,
    ...
    private static Supplier<SoundEvent> registerSoundEvents(String soundFileName) {
        ResourceLocation id = new ResourceLocation(IndustrialHellscape.MOD_ID, soundFileName);
