...
//            ModBlocks.GRAY_HORIZONTAL_CUTOUT_GRATE.get().asItem()
    ...
    private static final List<ItemLike> ROCKRETE_STONECUT_OUTPUT = List.of(
            ...
            ModBlocks.SMOOTH_GRAY_ROCKRETE_SLAB.get().asItem(),
            ModBlocks.SMOOTH_GRAY_ROCKRETE_STAIRS.get().asItem(),
            ...
            ModBlocks.SMOOTH_GREEN_ROCKRETE_SLAB.get().asItem(),
            ModBlocks.SMOOTH_GREEN_ROCKRETE_STAIRS.get().asItem(),
            ...
            ModBlocks.SMOOTH_YELLOW_ROCKRETE_SLAB.get().asItem(),
            ModBlocks.SMOOTH_YELLOW_ROCKRETE_STAIRS.get().asItem(),
            ...
            ModBlocks.SMOOTH_BLUE_ROCKRETE_SLAB.get().asItem(),
            ModBlocks.SMOOTH_BLUE_ROCKRETE_STAIRS.get().asItem(),
            ...
            ModBlocks.SMOOTH_RED_ROCKRETE_SLAB.get().asItem(),
            ModBlocks.SMOOTH_RED_ROCKRETE_STAIRS.get().asItem(),
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.INHELL_HAVEN_DEVICE.get())
                ...
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "haven_tool_from_crafting"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.VESSELGLASS.get(), vesselglassPerCraft)
                ...
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "vesselglass_from_crafting"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.DUCT.get(), hvacPerIngot *4)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "grate_from_crafting"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.TRUSS.get(), trussPerIngot *4)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "truss_from_crafting"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.METALWORKS.get(), metalworksPerCraft)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "metalworks_from_crafting"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.PIPEWORKS.get(), pipeworksPerCraft)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "pipeworks_from_crafting"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.IHEA_FURNITURE_KIT.get(), furnitureKitPerCraft)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "furniture_kit_from_crafting_log"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.IHEA_FURNITURE_KIT.get(), furnitureKitPerCraft)
                ...
                .requires(Items.IRON_INGOT)
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "furniture_kit_from_crafting_planks"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.ARMORED_DOOR.get(),3)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "base_door_from_crafting"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.VENT_TRAPDOOR.get(),2)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "base_trapdoor_from_crafting"));
...
//        reversibleBlockCrafting(ModBlocks.GRAY_HORIZONTAL_CUTOUT_GRATE.get(), ModBlocks.GRAY_VERTICAL_CUTOUT_GRATE.get(), recipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.JOB_APPLICATION.get(), 1)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "job_application"));
        //Create Body Pillow
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModBlocks.BODY_PILLOW.get(), 1)
                ...
                .requires(ItemTags.WOOL)
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", "body_pillow"));
        ...
        stonecutToAmount(
                ...
                1)  //1 amount output
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation(IndustrialHellscape.MOD_ID, "furniture_to_kit"));
    ...
    protected static void stonecutInputItemOutputList(List<ItemLike> stonecutOutputList, String inputTagName, Block inputItem, Consumer<FinishedRecipe> recipeOutput) {
        ...
        for (ItemLike itemLike : stonecutOutputList) {
            ...
            stonecutToAmount(ingredient, RecipeCategory.MISC, itemLike, 1)
                    .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                    .save(recipeOutput, new ResourceLocation(IndustrialHellscape.MOD_ID, inputTagName + "_stonecut_to_" + id));
        }
    }

    protected static void stonecutTagToOutputListPlusSlabs(List<ItemLike> stonecutOutputList, String inputTagName, TagKey<Item> inputTag, Consumer<FinishedRecipe> recipeOutput) {
    ...
    protected static void stonecutTagToOutputListRockrete(List<ItemLike> stonecutOutputList, String inputTagName, TagKey<Item> inputTag, Consumer<FinishedRecipe> recipeOutput) {
        Ingredient ingredient = Ingredient.of(inputTag);
    ...
    protected static void stonecutInputTagToOutputList(List<ItemLike> stonecutOutputList, String inputTagName, TagKey<Item> inputTag, Consumer<FinishedRecipe> recipeOutput) {
        Ingredient ingredient = Ingredient.of(inputTag);
    ...
    protected static void HavenSingleIngredientRecipe(Block outputBlock, int outputAmount, Ingredient inputIngredient, String recipeName, Consumer<FinishedRecipe> recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, outputBlock, outputAmount)
                ...
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", recipeName));
    }

    protected static void reversibleBlockCrafting(Block outputBlock, Block inputBlock, Consumer<FinishedRecipe> recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, outputBlock, 1)
                .requires(inputBlock)
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", inputBlockName + "_to_" + outputBlockName));
        //Output to Input
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, inputBlock, 1)
                .requires(outputBlock)
                .unlockedBy(getHasName(ModItems.INHELL_HAVEN_DEVICE.get()), has(ModItems.INHELL_HAVEN_DEVICE.get()))
                .save(recipeOutput, new ResourceLocation("industrialhellscape", outputBlockName + "_to_" + inputBlockName));
    }
    ...
    protected static SingleItemRecipeBuilder stonecutToAmount(Ingredient ingredient, RecipeCategory category, ItemLike result, int amount) {
        return new SingleItemRecipeBuilder(category, RecipeSerializer.STONECUTTER, ingredient, result, amount);
    }

    protected static void smeltAndBlast(Consumer<FinishedRecipe> recipeOutput, TagKey<Item> pIngredients, RecipeCategory pCategory, ItemLike pResult, int pSmeltingTime, int pBlastingTime, String pGroup) {
    ...
    protected static void oreSmelting(Consumer<FinishedRecipe> recipeOutput, TagKey<Item> pIngredients, RecipeCategory pCategory, ItemLike pResult,
    ...
    protected static void oreBlasting(Consumer<FinishedRecipe> recipeOutput, TagKey<Item> pIngredients, RecipeCategory pCategory, ItemLike pResult,
                                      float pExperience, int pCookingTime, String pGroup) {
