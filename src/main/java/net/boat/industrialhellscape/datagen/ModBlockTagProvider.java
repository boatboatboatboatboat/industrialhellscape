...
public class ModBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(ModTags.Blocks.ROCKRETE_BLOCKS)
                .add(
                        ModBlocks.SMOOTH_GRAY_ROCKRETE.get(),
                        ModBlocks.ROUGH_GRAY_ROCKRETE.get(),
                        ModBlocks.GRAY_ROCKRETE_PILLAR.get(),
                        ModBlocks.SMOOTH_GRAY_ROCKRETE_SLAB.get(),
                        ModBlocks.GRAY_ROCKRETE_PILLAR.get(),
                        ModBlocks.SMOOTH_GRAY_ROCKRETE_SLAB.get(),
                        ModBlocks.SMOOTH_GRAY_ROCKRETE_STAIRS.get(),
