...
Code inside the lambda functions will tick every time an external block checks for the capability.
 */
...
public class ModBlockCapabilities {
    ...
    public static void registerBlockEntityCapabilities(RegisterCapabilitiesEvent event) {
        IndustrialHellscape.LOGGER.info("InHell: ItemHandler for Block Entities registered");
    ...
    public static void registerBlockCapabilities(RegisterCapabilitiesEvent event) {
        IndustrialHellscape.LOGGER.info("InHell: ItemHandler for IntegerMultiBlocks registered");
        event.registerBlock(
