...
public class DebugBERenderer implements BlockEntityRenderer<DebugBE> {
    public DebugBERenderer(BlockEntityRendererProvider.Context context) {

    }
    @Override
    public void render(DebugBE pBlockEntity, float pPartialTick, PoseStack pPoseStack,
